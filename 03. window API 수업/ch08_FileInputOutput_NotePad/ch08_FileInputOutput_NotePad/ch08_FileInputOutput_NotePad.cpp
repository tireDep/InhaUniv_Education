// ch08_FileInputOutput_NotePad.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "ch08_FileInputOutput_NotePad.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_CH08_FILEINPUTOUTPUT_NOTEPAD, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CH08_FILEINPUTOUTPUT_NOTEPAD));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CH08_FILEINPUTOUTPUT_NOTEPAD));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_CH08_FILEINPUTOUTPUT_NOTEPAD);
